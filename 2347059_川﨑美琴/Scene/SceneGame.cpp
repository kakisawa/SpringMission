...
void SceneGame::CreateEnemy()
{
	...
	m_pEnemy[0] = make_shared<Enemy>(VGet(kEnemyPosX+15, kEnemyPosYLow, 0.0f));
	...
	//m_pEnemy[20] = make_shared<Enemy>(VGet(kEnemyPosX * 20, kEnemyPosYHigh, 0.0f));
	//m_pEnemy[21] = make_shared<Enemy>(VGet(kEnemyPosX * 20, kEnemyPosYHigh, 0.0f));
	//m_pEnemy[22] = make_shared<Enemy>(VGet(kEnemyPosX * 20, kEnemyPosYHigh, 0.0f));
	//m_pEnemy[23] = make_shared<Enemy>(VGet(kEnemyPosX * 20, kEnemyPosYHigh, 0.0f));
	//m_pEnemy[24] = make_shared<Enemy>(VGet(kEnemyPosX * 20, kEnemyPosYHigh, 0.0f));
	//m_pEnemy[25] = make_shared<Enemy>(VGet(kEnemyPosX * 20, kEnemyPosYHigh, 0.0f));
	//m_pEnemy[26] = make_shared<Enemy>(VGet(kEnemyPosX * 20, kEnemyPosYHigh, 0.0f));
	//m_pEnemy[27] = make_shared<Enemy>(VGet(kEnemyPosX * 20, kEnemyPosYHigh, 0.0f));
	//m_pEnemy[28] = make_shared<Enemy>(VGet(kEnemyPosX * 20, kEnemyPosYHigh, 0.0f));
	//m_pEnemy[29] = make_shared<Enemy>(VGet(kEnemyPosX * 20, kEnemyPosYHigh, 0.0f));
	//m_pEnemy[30] = make_shared<Enemy>(VGet(kEnemyPosX * 20, kEnemyPosYHigh, 0.0f));
	//m_pEnemy[31] = make_shared<Enemy>(VGet(kEnemyPosX * 20, kEnemyPosYHigh, 0.0f));
	//m_pEnemy[32] = make_shared<Enemy>(VGet(kEnemyPosX * 20, kEnemyPosYHigh, 0.0f));
	//m_pEnemy[33] = make_shared<Enemy>(VGet(kEnemyPosX * 20, kEnemyPosYHigh, 0.0f));
	//m_pEnemy[34] = make_shared<Enemy>(VGet(kEnemyPosX * 20, kEnemyPosYHigh, 0.0f));
	//m_pEnemy[35] = make_shared<Enemy>(VGet(kEnemyPosX * 20, kEnemyPosYHigh, 0.0f));
	//m_pEnemy[36] = make_shared<Enemy>(VGet(kEnemyPosX * 20, kEnemyPosYHigh, 0.0f));
	//m_pEnemy[37] = make_shared<Enemy>(VGet(kEnemyPosX * 20, kEnemyPosYHigh, 0.0f));
	//m_pEnemy[38] = make_shared<Enemy>(VGet(kEnemyPosX * 20, kEnemyPosYHigh, 0.0f));
	//m_pEnemy[39] = make_shared<Enemy>(VGet(kEnemyPosX * 20, kEnemyPosYHigh, 0.0f));
}